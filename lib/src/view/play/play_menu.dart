...
import 'package:lichess_mobile/src/view/computer/configure_computer_game_screen.dart';
            ...
            ListTile(
              onTap: () {
                ...
                Navigator.of(
                  ...
                  MaterialPageRoute(
                    builder: (context) => const ConfigureComputerGameScreen(),
                  ),
                );
              },
              leading: const Icon(Icons.computer),
              title: const Text('Play vs Computer'),
              subtitle: const Text('Offline - 8 difficulty levels'),
            ),
            ListTile(
              onTap: () {
                // Pops the play bottom sheet
