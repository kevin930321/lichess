...
class SocketClient {
  ...
  Future<void> connect() async {
    ...
    // Note: Cookie-based WebSocket authentication
    // Cookies should be automatically included by the platform's WebSocket implementation
    // during the HTTP upgrade handshake. We don't manually set Cookie headers here as
    // most WebSocket implementations handle this automatically if cookies exist.
